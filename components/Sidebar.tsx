...
export default function Sidebar({ branches, nic = "", password ="" }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* --- SIDEBAR CONTAINER --- */}
      <aside
        className={`fixed inset-y-0 left-0 z-[60] w-64 bg-slate-950 text-slate-300 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-slate-800/50 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] font-bold text-blue-500 uppercase tracking-[0.2em] mt-1">
                Management
              </p>
            </div>
          </div>
          ...
          <nav className="flex-1 p-4 space-y-2 mt-4">
            <Link
              ...
              className="flex items-center gap-3 px-4 py-3 bg-blue-600 text-white rounded-xl font-semibold shadow-lg shadow-blue-600/20 transition-all"
            >
            ...
            <div className="pt-4 px-2">
              ...
              <div className="relative group">
                <select className="w-full bg-slate-900 border border-slate-800 text-slate-300 text-sm rounded-xl px-4 py-3 outline-none focus:border-blue-500 appearance-none cursor-pointer">
                ...
                <ChevronDown
                  size={14}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none group-hover:text-slate-300 transition-colors"
                />
              </div>
            </div>
